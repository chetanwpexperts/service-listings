$(document).ready(function () {
    ...
    $(".cate-add-btn").click(function () {
        $(".add-ncate ul li:last-child").after('<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" id="category_name" name="category_name[]" class="form-control" placeholder="Category name *" required> </div> </div><div class="col-md-12"><div class="form-group"><label>Choose category image</label><input type="file" name="category_image[]" id="category_image" class="form-control" required></div></div><div class="col-md-12"><div class="form-group"><label>SEO Title</label><input type="text" id="seo_title" name="seo_title[]" class="form-control" placeholder="Category SEO Title name *" value="" required></div></div><div class="col-md-12"><div class="form-group"><label>SEO Description</label><textarea id="seo_description" name="seo_description[]" class="form-control" required></textarea></div></div><div class="col-md-12"><div class="form-group"><label>SEO Keywords</label><textarea id="keywords" name="keywords[]" class="form-control" required></textarea></div></div></div></li>');
    });
    //LISTING CATEGORY REMOVE - APPEND
    $(".cate-rem-btn").click(function () {
        $(".add-ncate ul li:last-child").remove();
    });
    $(".cateotherinfo-add-btn").click(function () {
        var count = $("#countinfo").val();
        count = parseInt(count) + 1;
        $("#countinfo").val(count);
        $(".add-ncateotherinfo ul li:last-child").after('<li> <div class="row"> <div class="col-md-12"> <div class="form-group"><input class="form-control" type="text" name="heading[]" id="heading_'+count+'" required placeholder="heading" /></div></div><div class="col-md-12"> <div class="form-group"> <textarea id="otherinfo_'+count+'" name="otherinfo[]" class="form-control" required></textarea></div> </div></div></li>');
        CKEDITOR.replace('otherinfo_'+count);
    });
    //LISTING CATEGORY REMOVE - APPEND
    $(".cateotherinfo-rem-btn").click(function () {
        $(".add-ncatefaq ul li:last-child").remove();
    });
    $(".catefaq-add-btn").click(function () {
        var count = $("#countfaq").val();
        count = parseInt(count) + 1;
        $("#countfaq").val(count);
        $(".add-ncatefaq ul li:last-child").after('<li> <div class="row"> <div class="col-md-12"> <div class="form-group"><input class="form-control" type="text" name="heading[]" id="faqheading_'+count+'" required placeholder="heading" /></div></div><div class="col-md-12"> <div class="form-group"> <textarea id="faq_'+count+'" name="otherinfo[]" class="form-control" required></textarea></div> </div></div></li>');
        CKEDITOR.replace('faq_'+count);
    });
    //LISTING CATEGORY REMOVE - APPEND
    $(".catefaq-rem-btn").click(function () {
        $(".add-ncatefaq ul li:last-child").remove();
    });
    //COUNTRY ADD - APPEND
    ...
    $(".scat-add-btn").click(function () {
        $(".add-ncate ul li:last-child").after('<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <input type="text" class="form-control" placeholder="Sub category name *" name="category_name[]" required> </div> </div> <div class="col-md-12"><div class="form-group"><label>Choose category image</label><input type="file" name="category_image[]" id="category_image" class="form-control" required></div></div></div> </li>');
    });
    ...
    $(".lis-add-oadvideo").on('click', function() {
        $(".add-list-map ul li:last-child").after('<li> <div class="row"> <div class="col-md-12"> <div class="form-group"> <textarea id="listing_video" name="gallery_video[]" class="form-control" placeholder="Paste Your Youtube Url here"></textarea> </div> </div> </div> </li>');
    });
...
jQuery(document).ready(function ($) {
	...
	*/
	...
	var nav_nave_controller = window.location.pathname.split("/");
	if(nav_nave_controller[3] == "sections")
	{
		$('.ic-seo a').addClass('mact');
		$('.ic-seo a').parent().find('div').css({"display":"block"});
	}
	$(".ad-menu ul li a").each(function(){
		var href = $(this).text();
		var href = href.toLowerCase();
		console.log("nav_nave_controller " + nav_nave_controller[3]);
		console.log("nav_nave " + nav_nave);
		console.log("href " + href);
		if (href == nav_nave || href == nav_nave_controller[3])
		{
			$(this).addClass('mact');
...
$(".ad-menu ul li a").each(function(){
	...
	hrefval = href.substring(href.lastIndexOf('/')+1);
    if(hrefval == nav_nave){
        $(this).addClass('s-act');
        $(this).addClass('mact');
    }
